...
void SceneDiffuse::setLightParams(QuatCamera camera)
{
	...
	prog.setUniform("mat.Ld", 0.9f, 0.9f, 0.9f);//what elements does Ld have?
	prog.setUniform("mat.La", 0.5f, 0.5f, 0.5f);
	prog.setUniform("mat.Ls", 0.2f, 0.2f, 0.2f);
...
void SceneDiffuse::render(QuatCamera camera)
{
	...
	prog.setUniform("mat.Kd", 0.46f, 0.29f, 0.0f); // Sets the diffuse reflectivity
	prog.setUniform("mat.Ka", 0.46f, 0.29f, 0.0f);
	prog.setUniform("mat.Ks", 0.46f, 0.29f, 0.0f);
	...
	//Now set up the teapot 
	 ...
	 prog.setUniform("mat.Kd", 0.51f, 1.0f, 0.49f); // What elements does Kd have?
	 prog.setUniform("mat.Ka", 0.51f, 1.0f, 0.49f); // What elements does Kd have?
	 prog.setUniform("mat.Ks", 0.51f, 1.0f, 0.49f); // What elements does Kd have?
	 prog.setUniform("mat.shininess", 3.0f);
	 prog.setUniform("mat.constant", 1.0f);
	 prog.setUniform("mat.linear", 0.01f);
	 prog.setUniform("mat.quad", 0.001f);
	 prog.setUniform("mat.camPos", 0.5f, 0.5f, 0.5f);
